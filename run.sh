...
trap 'echo \[`date`\] `whoami`@`hostname`:`realpath $0`, $LINENO | mail -s "cmd interrupted" tianyou.liang@student.uts.edu.au' INT TERM HUP
...
echo $best_i, $best_v
python test.py totalseg-spineLSpelvic-small $lp/ckpt-${best_i}.pth
